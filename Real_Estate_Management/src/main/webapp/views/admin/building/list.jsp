                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2">
                                                <div>
                                                    ...
                                                    <select name="" id="district" class="chosen-select form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2">
                                                <div>
                                                    ...
                                                    <input type="number" id="baseNumber" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div>
                                                    <label for="areaFrom">Diện tích từ </label>
                                                    <input type="number" id="areaFrom" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div>
                                                    <label for="areaTo">Diện tích đến </label>
                                                    <input type="number" id="areaTo" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div>
                                            ...
                                            <div class="col-sm-2">
                                                <div>
                                                    ...
                                                    <input type="number" id="priceTo" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <div>
                                                    ...
                                                    <select name="" id="staff" class="chosen-select form-control">
                                    ...
                                    <div class="pull-right tableTools-container">
                                        <div class="dt-buttons btn-overlap btn-group">
                                            <a class="dt-button buttons-collection buttons-colvis btn btn-white btn-primary btn-bold"
                                                data-toggle="tooltip" title="Thêm" href="<c:url value='/admin-building?action=EDIT'/>">
