...
function openModalAssignmentBuilding() {
    $('#assignmentBuildingModal').modal();
        ...
        $('#btnAssignBuilding').click(function (e) {
            ...
            const staffs = $('#staffList').find('tbody input[type=checkbox]:checked').map(function () {
                return $(this).val();
            }).get();
        ...
        $('#deleteBuilding').click(function (e) {
            ...
            const buildingIds = $('#buildingList').find('input[type=checkbox]:checked').map(function () {
                return $(this).val();
            }).get();
